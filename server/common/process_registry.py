...
class ProcessRegistry:
    ...
    def register_process(self, pid: int, username: str, file_path: Optional[str], 
                        process_type: str, cmd_id: str) -> bool:
        """
            ...
            while True:
                try:
                    ...
                    if stats['total_memory_mb'] > self.MAX_TOTAL_MEMORY_MB * 0.8:
                        logger.warning(f"High memory usage: {stats['total_memory_mb']:.1f}MB/{self.MAX_TOTAL_MEMORY_MB}MB")
