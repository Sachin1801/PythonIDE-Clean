      ...
      try {
        ...
        this.wsInfo.rws.onmessage = (event) => {
          ...
          try {
            ...
            console.log("📥 [VmIde] WebSocket message received:", { id: message.id, cmd_id: message.cmd_id, code: message.code, programId: message.data?.program_id, replSessionId: this.replSessionId });
