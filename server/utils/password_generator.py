...
class PasswordGenerator:
    ...
    def export_to_csv(self, users_with_passwords, filename_prefix="user_credentials"):
        ...
        admin_data_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "adminData")
...
def main():
    ...
    parser.add_argument("--csv", type=str, help="CSV file to load users from and regenerate passwords")
    parser.add_argument("--test", action="store_true", help="Generate test passwords and show examples")
