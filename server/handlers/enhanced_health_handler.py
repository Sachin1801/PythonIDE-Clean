        ...
        try:
            ...
            health_data = {
                ...
                'users': {
                    ...
                    'utilization_percent': round((session_stats['active_users'] / session_stats['limits']['max_users']) * 100, 1)
                },
                ...
                'session_details': session_stats['sessions'] if len(session_stats['sessions']) <= 10 else f"Too many sessions to display ({len(session_stats['sessions'])})"
            }
