    ...
    async def get(self):
        ...
        try:
            ...
            result = {
                ...
                "users": [{"username": u["username"], "role": u["role"]} for u in users[:10]],  # First 10 users
        ...
        try:
            ...
            if action == "fix_directories":
                ...
                result = subprocess.run(
                    [
                        "python3",
                        "/app/server/migrations/create_full_class_with_consistent_passwords.py",
                        "--environment",
                        "production",
                    ],
                    capture_output=True,
            ...
            if result.returncode == 0:
                ...
                response = {"success": False, "error": result.stderr[-1000:], "output": result.stdout[-1000:]}
