...
class REPLRegistry:
    ...
    def __init__(self):
        ...
        self._cleanup_thread = threading.Thread(target=self._cleanup_expired_processes, daemon=True)
        self._cleanup_thread.start()

        self._initialized = True
        logger.info("REPL Registry initialized")

    def get_or_create_repl(
        self, username: str, file_path: Optional[str], cmd_id: str, client, loop
    ) -> HybridREPLThread:
        """
